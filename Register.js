          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Join Mock-Mate and start practicing
              </p>
            </div>
          ...
          >
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center space-x-3">
                ...
                <span>Create your account and set your goals</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                  <span className="text-sm font-bold">2</span>
                </div>
                <span>Practice with coding challenges and mock interviews</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                  <span className="text-sm font-bold">3</span>
                </div>
                <span>Get AI-powered feedback and track your progress</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                  <span className="text-sm font-bold">4</span>
                </div>
                <span>Land your dream job with confidence</span>
              </div>
            </div>
          </motion.div>
        </div>
